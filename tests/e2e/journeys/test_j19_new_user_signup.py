...
async def test_j19_new_user_signup(
    ...
    async with httpx.AsyncClient(
        ...
        with journey_step("US1 visitor signs up with email, verifies, and logs in"):
        ...
        with journey_step("US2 approval mode blocks login until admin approval"):
        ...
        with journey_step("US3 Google OAuth signup completes missing profile fields"):
        ...
        with journey_step("US3 GitHub OAuth signup honors configured organisation checks"):
        ...
        with journey_step("US4 authenticated user links another OAuth provider"):
