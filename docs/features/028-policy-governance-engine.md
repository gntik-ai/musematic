...
!!! info "Source spec"
    [028-policy-governance-engine](https://github.com/gntik-ai/musematic/tree/main/specs/028-policy-governance-engine) · Status from spec: **Draft** · Created: 2026-04-12

## Purpose

Implement policy CRUD, versioning, attachment to agents/fleets/workspaces, governance compiler (human-readable → machine-usable bundles), tool gateway with deterministic enforcement, memory write gate, maturity-gated access rules, and purpose-bound authorization checks.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/028-policy-governance-engine/plan.md) or the
`apps/control-plane/src/platform/policies/` bounded context.
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/028-policy-governance-engine/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/028-policy-governance-engine/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/028-policy-governance-engine/tasks.md) — task breakdown
  (if present)
