...
!!! info "Source spec"
    [026-home-dashboard](https://github.com/gntik-ai/musematic/tree/main/specs/026-home-dashboard) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Home page with recent activity feed, pending actions, quick actions, workspace summary metrics, and real-time updates via WebSocket.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-home-dashboard/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-home-dashboard/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-home-dashboard/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-home-dashboard/tasks.md) — task breakdown
  (if present)
