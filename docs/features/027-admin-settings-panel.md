...
!!! info "Source spec"
    [027-admin-settings-panel](https://github.com/gntik-ai/musematic/tree/main/specs/027-admin-settings-panel) · Status from spec: **Draft** · Created: 2026-04-12

## Purpose

Admin settings with tabs for users, signup policy, quotas, connectors, email, and security configuration.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/027-admin-settings-panel/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/027-admin-settings-panel/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/027-admin-settings-panel/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/027-admin-settings-panel/tasks.md) — task breakdown
  (if present)
