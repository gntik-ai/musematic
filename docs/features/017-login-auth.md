...
!!! info "Source spec"
    [017-login-auth](https://github.com/gntik-ai/musematic/tree/main/specs/017-login-auth) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Login page with email/password, TOTP MFA step, lockout handling, password reset flow, and MFA enrollment dialog.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/017-login-auth/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/017-login-auth/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/017-login-auth/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/017-login-auth/tasks.md) — task breakdown
  (if present)
