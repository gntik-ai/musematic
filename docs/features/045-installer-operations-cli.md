...
!!! info "Source spec"
    [045-installer-operations-cli](https://github.com/gntik-ai/musematic/tree/main/specs/045-installer-operations-cli) · Status from spec: **Draft** · Created: 2026-04-16
...
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/045-installer-operations-cli/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/045-installer-operations-cli/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/045-installer-operations-cli/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/045-installer-operations-cli/tasks.md) — task breakdown
  (if present)
