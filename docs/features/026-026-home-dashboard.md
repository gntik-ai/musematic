...
!!! info "Source spec"
    [026-026-home-dashboard](https://github.com/gntik-ai/musematic/tree/main/specs/026-026-home-dashboard) · Status from spec: **Draft** · Created: [DATE]
...
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-026-home-dashboard/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-026-home-dashboard/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-026-home-dashboard/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/026-026-home-dashboard/tasks.md) — task breakdown
  (if present)
