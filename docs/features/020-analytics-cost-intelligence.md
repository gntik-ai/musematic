...
!!! info "Source spec"
    [020-analytics-cost-intelligence](https://github.com/gntik-ai/musematic/tree/main/specs/020-analytics-cost-intelligence) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Implement usage event pipeline (Kafka to ClickHouse), materialized views for rollups, cost-per-quality computation, optimization recommendations, budget forecasting, and cost intelligence API.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/020-analytics-cost-intelligence/plan.md) or the
`apps/control-plane/src/platform/analytics/` bounded context.
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/020-analytics-cost-intelligence/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/020-analytics-cost-intelligence/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/020-analytics-cost-intelligence/tasks.md) — task breakdown
  (if present)
