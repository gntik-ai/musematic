# Accounts Bounded Context — User Registration, Lifecycle, and Invitations

!!! info "Source spec"
    [016-accounts-bounded-context](https://github.com/gntik-ai/musematic/tree/main/specs/016-accounts-bounded-context) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Implement user registration, lifecycle management (pending_verification → pending_approval → active → suspended → blocked → archived), invitations, email verification, and admin approval workflows.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/016-accounts-bounded-context/plan.md) or the
`apps/control-plane/src/platform/accounts/` bounded context.
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/016-accounts-bounded-context/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/016-accounts-bounded-context/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/016-accounts-bounded-context/tasks.md) — task breakdown
  (if present)
