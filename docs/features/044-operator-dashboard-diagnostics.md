...
!!! info "Source spec"
    [044-operator-dashboard-diagnostics](https://github.com/gntik-ai/musematic/tree/main/specs/044-operator-dashboard-diagnostics) · Status from spec: **Draft** · Created: 2026-04-16
...
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/044-operator-dashboard-diagnostics/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/044-operator-dashboard-diagnostics/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/044-operator-dashboard-diagnostics/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/044-operator-dashboard-diagnostics/tasks.md) — task breakdown
  (if present)
