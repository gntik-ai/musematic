...
!!! info "Source spec"
    [010-sandbox-manager](https://github.com/gntik-ai/musematic/tree/main/specs/010-sandbox-manager) · Status from spec: **Draft** · Created: 2026-04-10

## Purpose

Go Sandbox Manager — isolated code execution pods for agent sandboxing and code-as-reasoning

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/010-sandbox-manager/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/010-sandbox-manager/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/010-sandbox-manager/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/010-sandbox-manager/tasks.md) — task breakdown
  (if present)
