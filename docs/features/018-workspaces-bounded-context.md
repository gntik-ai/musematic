...
!!! info "Source spec"
    [018-workspaces-bounded-context](https://github.com/gntik-ai/musematic/tree/main/specs/018-workspaces-bounded-context) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Implement workspace CRUD, membership management, workspace roles, goals, super-context settings, isolation enforcement, and workspace subscription metadata.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/018-workspaces-bounded-context/plan.md) or the
`apps/control-plane/src/platform/workspaces/` bounded context.
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/018-workspaces-bounded-context/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/018-workspaces-bounded-context/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/018-workspaces-bounded-context/tasks.md) — task breakdown
  (if present)
