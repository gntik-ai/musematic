# Simulation Controller — Isolated Simulation Environments

!!! info "Source spec"
    [012-simulation-controller](https://github.com/gntik-ai/musematic/tree/main/specs/012-simulation-controller) · Status from spec: **Draft** · Created: 2026-04-10

## Purpose

Go Simulation Controller — isolated simulation environments for agent and fleet testing against synthetic data without production side effects, accredited testing environments

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/012-simulation-controller/plan.md) or the
`apps/control-plane/src/platform/simulation/` bounded context.
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/012-simulation-controller/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/012-simulation-controller/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/012-simulation-controller/tasks.md) — task breakdown
  (if present)
