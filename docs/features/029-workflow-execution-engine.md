...
!!! info "Source spec"
    [029-workflow-execution-engine](https://github.com/gntik-ai/musematic/tree/main/specs/029-workflow-execution-engine) · Status from spec: **Draft** · Created: 2026-04-12

## Purpose

Implement YAML workflow parser, JSON Schema validation, compiler (YAML to typed IR), append-only execution journal, scheduler with priority and reasoning budget awareness, dispatch via runtime infrastructure, replay/resume/rerun, safe hot change, and compensation.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/029-workflow-execution-engine/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/029-workflow-execution-engine/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/029-workflow-execution-engine/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/029-workflow-execution-engine/tasks.md) — task breakdown
  (if present)
