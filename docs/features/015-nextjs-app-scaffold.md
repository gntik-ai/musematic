# Next.js Application Scaffold — Frontend Foundation

!!! info "Source spec"
    [015-nextjs-app-scaffold](https://github.com/gntik-ai/musematic/tree/main/specs/015-nextjs-app-scaffold) · Status from spec: **Draft** · Created: 2026-04-11

## Purpose

Initialize Next.js 14+ with App Router, TypeScript, shadcn/ui, Tailwind CSS, TanStack Query, Zustand, typed API client, WebSocket client, app shell with sidebar navigation, command palette, and all shared UI components.

## How it works

TODO(andrea): summarise the implementation approach (2–4 sentences)
from [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/015-nextjs-app-scaffold/plan.md) or the
...
- [spec.md](https://github.com/gntik-ai/musematic/blob/main/specs/015-nextjs-app-scaffold/spec.md) — functional
  requirements and acceptance scenarios
- [plan.md](https://github.com/gntik-ai/musematic/blob/main/specs/015-nextjs-app-scaffold/plan.md) — implementation
  approach
- [tasks.md](https://github.com/gntik-ai/musematic/blob/main/specs/015-nextjs-app-scaffold/tasks.md) — task breakdown
  (if present)
