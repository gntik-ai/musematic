...
| topics[14].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[16].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[26].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[27].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[27].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[48].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[49].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[50].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[52].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[53].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[53].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[54].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[54].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[62].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[62].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[63].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[63].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[64].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[64].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[6].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[8].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
