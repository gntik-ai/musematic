...
| topics[25].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[47].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[48].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[50].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[51].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[51].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[61].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[61].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
