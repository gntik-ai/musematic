...
| topics[13].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[13].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[14].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[14].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[19].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[21].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[27].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[34].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[35].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[35].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[56].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[58].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[59].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[59].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[60].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[60].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[61].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[61].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[67].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[69].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[6].partitions | int | `12` | 30-day retention; the audit chain is the durable record. |
| topics[70].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[70].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[71].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[71].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[72].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[72].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[73].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[73].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[74].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[74].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[75].partitions | int | `6` | Configures `topics.partitions` for the kafka chart. |
| topics[75].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[7].partitions | int | `3` | 7-day retention; consumers must be caught up by then. |
...
| topics[9].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
...
| vault | object | `{"fullnameOverride":"musematic-vault","injector":{"enabled":false},"server":{"auditStorage":{"enabled":true,"size":"5Gi"},"dataStorage":{"enabled":true,"size":"10Gi"},"extraEnvironmentVars":{"VAULT_CACERT":"/vault/userconfig/tls/ca.crt"},"ha":{"enabled":true,"raft":{"enabled":true,"setNodeId":true},"replicas":3}},"ui":{"enabled":true,"serviceType":"ClusterIP"}}` | Values passed to the upstream hashicorp/vault dependency. |
| vault.fullnameOverride | string | `"musematic-vault"` | Overrides the upstream Vault fullname so wrapper policy jobs and platform clients use the same service DNS name. |
