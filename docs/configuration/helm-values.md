...
| topics[16].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[18].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[24].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[31].retentionMs | int | `1209600000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[55].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
| topics[56].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[66].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[69].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
| topics[69].retentionMs | int | `604800000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[8].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
