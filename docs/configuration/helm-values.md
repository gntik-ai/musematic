...
| topics[18].retentionMs | int | `2592000000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[20].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[26].partitions | int | `12` | Configures `topics.partitions` for the kafka chart. |
...
| topics[57].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[60].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
...
| topics[68].retentionMs | int | `259200000` | Configures `topics.retentionMs` for the kafka chart. |
