...
- [ ] T070 [P] Run full TypeScript check: `pnpm tsc --noEmit` — fix ALL errors until output is clean
- [ ] T071 [P] Run ESLint: `pnpm next lint` — fix ALL warnings and errors until output is clean
...
- [ ] T074 Run `pnpm build` — verify First Load JS for main route < 200kB; if exceeded, identify large imports (highlight.js, recharts) and add dynamic imports where not already done
