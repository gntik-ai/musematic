...
- [x] T103 [W16E] Run `helm template deploy/helm/platform/ --set oauth.google.enabled=true --set oauth.google.clientId=test...` → renders without errors; verify the rendered Deployment has the expected env-var injection + volume mounts.
