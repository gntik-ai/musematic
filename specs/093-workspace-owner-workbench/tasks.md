...
- [X] T006 [W18A] Run `alembic upgrade head` locally; verify migration applies cleanly + downgrade -1 removes 3 columns + 1 table without data loss in existing 5 ARRAY + 1 JSONB columns of `workspaces_settings`.
