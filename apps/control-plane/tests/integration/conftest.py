...
class WorkflowExecutionStack:
    ...
    runtime_controller_stub: AsyncMock
...
@pytest.fixture
def runtime_controller_stub(workflow_execution_stack: WorkflowExecutionStack) -> AsyncMock:
...
async def workflow_execution_app(
    ...
    app.dependency_overrides[get_workflow_service] = lambda: workflow_execution_stack.workflow_service
    app.dependency_overrides[get_execution_service] = (
        lambda: workflow_execution_stack.execution_service
    )
    yield app
