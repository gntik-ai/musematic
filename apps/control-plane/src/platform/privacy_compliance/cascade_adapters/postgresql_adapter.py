...
USER_IDENTITY_COLUMNS: dict[str, list[str]] = {
    ...
    "plan_versions": ["created_by"],
    "subscriptions": ["created_by_user_id"],
    "overage_authorizations": ["authorized_by_user_id", "revoked_by_user_id"],
    "cost_anomalies": ["acknowledged_by"],
    "cost_attributions": ["user_id"],
    "cost_overrides": ["issued_by", "redeemed_by"],
    "runbooks": ["updated_by"],
    "post_mortems": ["created_by"],
    "failover_plans": ["created_by"],
    "failover_plan_runs": ["initiated_by"],
    "maintenance_windows": ["scheduled_by"],
    ...
    "two_person_approval_challenges": ["initiator_id", "co_signer_id"],
