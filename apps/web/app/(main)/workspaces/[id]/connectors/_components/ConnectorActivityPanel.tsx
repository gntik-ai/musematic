    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-md border p-3"><p className="text-2xl font-semibold">{delivered}</p><p className="text-xs text-muted-foreground">Delivered</p></div>
          <div className="rounded-md border p-3"><p className="text-2xl font-semibold">{failed}</p><p className="text-xs text-muted-foreground">Failed</p></div>
        </div>
        <div className="space-y-2">
          ...
          {!deliveries.length ? <p className="text-sm text-muted-foreground">No deliveries recorded.</p> : null}
        </div>
      </CardContent>
    </Card>
  );
