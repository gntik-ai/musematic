...
| controlPlane.connections.platformStaffPostgresDsn | string | `""` | Configures `controlPlane.connections.platformStaffPostgresDsn` for the platform chart. |
...
| controlPlane.tenancy | object | `{"cacheTtlSeconds":60,"enforcementLevel":"lenient"}` | Configures `controlPlane.tenancy` for the platform chart. |
| controlPlane.tenancy.cacheTtlSeconds | int | `60` | Configures `controlPlane.tenancy.cacheTtlSeconds` for the platform chart. |
| controlPlane.tenancy.enforcementLevel | string | `"lenient"` | Configures `controlPlane.tenancy.enforcementLevel` for the platform chart. |
...
| postgresql | object | `{"bootstrap":{"postInitSQL":[]},"createNamespace":false,"credentials":{"database":"musematic","password":"change-me","username":"musematic"},"enabled":true,"environment":"production"}` | Configures `postgresql` for the platform chart. |
| postgresql.bootstrap | object | `{"postInitSQL":[]}` | Configures `postgresql.bootstrap` for the platform chart. |
| postgresql.bootstrap.postInitSQL | list | `[]` | Configures `postgresql.bootstrap.postInitSQL` for the platform chart. |
...
| tenancy | object | `{"cacheTtlSeconds":60,"defaultTenantSlug":"default","defaultTenantSubdomain":"app","hostnameMiddlewareEnabled":true,"reservedSlugs":["api","grafana","status","www","admin","platform","webhooks","public","docs","help"]}` | Configures tenant hostname resolution and default tenant bootstrap values. |
| tenancy.cacheTtlSeconds | int | `60` | Configures `tenancy.cacheTtlSeconds` for the platform chart. |
| tenancy.defaultTenantSlug | string | `"default"` | Configures `tenancy.defaultTenantSlug` for the platform chart. |
| tenancy.defaultTenantSubdomain | string | `"app"` | Configures `tenancy.defaultTenantSubdomain` for the platform chart. |
| tenancy.hostnameMiddlewareEnabled | bool | `true` | Configures `tenancy.hostnameMiddlewareEnabled` for the platform chart. |
| tenancy.reservedSlugs | list | `["api","grafana","status","www","admin","platform","webhooks","public","docs","help"]` | Configures `tenancy.reservedSlugs` for the platform chart. |
...
| webStatus.statusApiInternalUrl | string | `"http://musematic-control-plane-api.platform.svc.cluster.local:8000"` | Configures `webStatus.statusApiInternalUrl` for fallback refreshes. |
| webStatus.tls | object | `{"clusterIssuer":"letsencrypt-prod","enabled":true}` | Configures `webStatus.tls` for the public status ingress. |
